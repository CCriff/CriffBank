...
public class AdminMenu implements Menu {
	...
	public void showMenu() {
		...
		System.out.println("                                                   ");
			...
			System.out.println("        *     8. EDIT AN ACCOUNT INFORMATION      *");
			System.out.println("        *     9. CLOSE ACCOUNT                    *");
			System.out.println("        *     10. LOGOUT                          *");
			System.out.println("        *     11. EXIT CRIFF BANKING SYSTEM       *");
			System.out.println("        *******************************************");
	...
	public Menu process() {
		...
		case 6: acctService.viewAllAccounts(); break;
		case 7: acctService.viewAllUsers(); break;
		case 8: acctService.edit(); break;
		case 9: acctService.deleteAcct(); break;
		case 10: empService.employeelogout(); break;
		default:
	...
	public void getUserInput() {
		inputValue = InputUtility.getIntChoice(11);
